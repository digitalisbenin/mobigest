...
<!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                        ...
                        {{--  <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                ...
                                <form action="{{ route('detail-stock', $id) }}" method="GET">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" name="NomFours" value="{{ request('NomFours') }}" placeholder="Fournisseur">
                                        </div>
                                ...
                                <button type="button" class="btn btn-secondary d-flex ml-3 mt-4" onclick="window.location='{{ url('get-etat-stock') }}'"> <i class="fas fa-arrow-left mt-1"></i>  Retour</button>
            ...
            <tr>
                <td colspan="11" class="text-center text-muted">Aucune donnée disponible</td>
            </tr>
        @else
