...
<!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h5 class=" mb-0 text-gray-800">REGLER UNE CREANCE</h5>
                        <div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="annulerVenteModalLabel{{ $vente->IDVente }}">REGLER UNE CREANCE </h5>
        ...
        document.querySelectorAll("[id^='annulerVenteModal']").forEach(modal => {
            modal.addEventListener("shown.bs.modal", function () {
                ...
                function calculerReste() {
                    ...
                    detteActuelle.value = totalReste.toFixed(0);
                }
