...
@section('title', 'Point des Règlements')
@section('content')
<!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                        <h5 class=" mb-0 text-gray-800">POINT DES REGLEMENTS</h5>
                            ...
                            {{--  <a href="{{url('reglement-ventes')}}" class="btn btn-sm btn-primary mx-2" >
                              Nouveau
                            ...
                            <div class="col d-flex">
                               ...
                               {{--  <div>
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800 text-end">Total: {{$reglementVente->count()}}</div>
                                    ...
                                    <div class="table-responsive" style=" overflow-y: auto; height:410px;">
                                        <table id="tableVente" class="table table-bordered table-striped table-hover align-middle">
                                            ...
                                            <tr class="text-center" style=" white-space: nowrap;">
                                                <td  class="category-date">{{ \Carbon\Carbon::parse($vente->DateRegl)->format('d-m-Y') }} {{ $vente->HeureEnreg }}</td>
                                                <td class="category-title" >{{ $vente->reglementVente->entreeArticle->articlee->Designation  }}</td>
                                                ...
                                                <td class="category-capacite" >{{ $vente->reglementVente->NomClient }}</td>
...
$(document).ready(function() {
    $("#searchInput, #searchAuthor,#searchCapacite, #startDate, #endDate").on("keyup change", function() {
        ...
        console.log("Valeurs de recherche :", value, value4, author, startDate, endDate);
