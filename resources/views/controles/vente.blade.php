...
@section('title', 'Point des Ventes Périodiques')
@section('content')
<!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h5 class=" mb-0 text-gray-800"> POINT DES VENTES PERIODIQUES</h5>
                        {{--  <div>
                            ...
                            <div class="card shadow mb-1">
                                ...
                                <div
                                    ...
                                    <div class="col-md-8 d-flex align-items-center">
                                        <input type="text" id="searchCapacite" class="form-control  me-2" placeholder="Rechercher par Nom Client ...">
                                    ...
                                    <table id="tableVente" class="table table-bordered table-striped table-hover align-middle">
                                        ...
                                        <tr class="text-center" style=" white-space: nowrap;">
                                            ...
                                            {{--  <td class="d-flex">
                                                ...
                                                <a href="#" class="btn btn-sm btn-primary mx-1" data-bs-toggle="modal" data-bs-target="#modifierVenteModal{{ $vente->IDVente }}" data-bs-placement="top" title="Modifier vente Accessoire">
