...
@section('title', 'Regler une creance')
@section('content')
<!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">LISTE DES DEBITEURS</h1>
                            ...
                            {{--  <a href="{{url('liste-reglement-ventes')}}" class="btn btn-sm btn-secondary mx-2" >
                              Retour
                                    ...
                                    <div class="table-responsive" style=" overflow-y: auto; height:410px;">
                                        <table id="tableVente" class="table table-bordered table-striped table-hover align-middle">
                                            ...
                                            <tr class="text-center" style=" white-space: nowrap;">
                                                ...
                                                <td class="category-author"  >{{ $vente->usere->name }}</td>
                                                {{--  <td class="d-flex">
