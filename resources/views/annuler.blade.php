...
@section('title', 'Annuler une Vente')
@section('content')
<!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h5 class=" mb-0 text-gray-800">ANNULER UNE VENTE</h5>
                        <div>
                            ...
                            <div class="card shadow mb-1">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <div class="col-md-12 d-flex align-items-center">
                                        <form method="GET" action="{{url('ventes-article')}}" class="d-flex  mt-3">

                                            <!-- Champ pour la date de début -->
                                            <div class="mb-1 me-1 mt-2 d-flex align-items-center">
                                                <label for="start_date" class="form-label mt-2">DEBUT</label>
                                                <input type="date" class="form-control me-3 ml-2" id="start_date" name="start_date" value="{{ request('start_date') }}">
                                            </div>

                                            <!-- Champ pour la date de fin -->
                                            <div class="mb-1 me-3 mt-2 d-flex align-items-center">
                                                <label for="end_date" class="form-label mt-2">FIN</label>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea style="text-transform: uppercase;"  class="form-control" rows="3" name="CauseAnnulat" id="CauseAnnulat" required></textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card p-1 mb-1 h-90">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="NomClient" id="NomClient" value="{{$vente->NomClient}}">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" rows="4" name="Observations" id="Observations">{{$vente->Observations}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="col-md-8 equal-height">
                                                            <div class="card p-1 mb-1 h-90">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 mb-3">
                                                                        <label class="form-label">NOM DU CLIENT</label>
                                                                        <input type="text" class="form-control" name="NomClient" value="{{ $vente->NomClient  }}" >
                                                                    </div>
                                                                    <div class="col-md-6 mb-3">
                                                                        <label class="form-label">CONTACT(S)</label>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label">OBSERVATIONS</label>
                                                                    <textarea class="form-control" rows="4" name="Observations" >{{ $vente->Observations  }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 equal-height">
                            ...
                            <div class="card p-1 mb-1 h-90">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        <label class="form-label">ACCESSOIRES</label>
                                        <select class="form-select" id="IdEntree " name="IdEntree" required>
                                            <option value="">Sélectionner un accessoire</option>
                                            @foreach($entreeArticles as $article)
                                                <option value="{{ $article->IdEntree }}">{{ $article->articlee->famille->LibFamille }}</option>
                                            @endforeach
                                        </select>
                                    </div>
