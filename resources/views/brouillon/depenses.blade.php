...
<body>
    ...
    <div class="header">
        ...
        AVAILABLE GADGET STORE / ENREGISTRER UNE DEPENSE
    </div>
    <div class="user-info">
...
<td class="action-icons">
    ...
    <div class="modal fade" id="modalEnregistrement" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="depenseModalLabel">FICHE D'UNE DEPENSE...</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label class="form-label">Numéro Enreg.</label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Date Enreg.</label>
                                <input type="date" class="form-control" id="dateEnreg" >
                            </div>
                        </div>
                        <div class="mb-3">
